    ...
    <div class="card">
        <div class="card-body">
            <div style="display: flex; justify-content: space-between;">
                <h4 class="card-title">@lang('crud.tests.index_title')</h4>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                    <thead>
                        <tr>
                            <th class="text-left">
                                @lang('crud.tests.inputs.type')
                            </th>
                            <th class="text-left">
                                @lang('crud.tests.inputs.date')
                            </th>
                            <th class="text-left">
                                @lang('crud.tests.inputs.course_id')
                            </th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $test->type ?? '-' }}</td>
                            <td>{{ $test->date ?? '-' }}</td>
                            <td>{{ optional($test->course)->title ?? '-' }}</td>
